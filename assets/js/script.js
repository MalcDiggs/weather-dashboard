...
// cityName in localStorage
var cityName = localStorage.getItem('cityNameStore');

// Current day parameters (city name + weather units of measurements)
var URLWeather = "https://api.openweathermap.org/data/2.5/weather?q=" + cityName + '&units=imperial' + apiKey;

// 5-days forecast parameters (city name + weather units of measurements)
